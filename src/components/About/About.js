  ...
  return (
    <AboutWrapper id="about">
      ...
      <AboutInfo>
        ...
        <p>
          Hi, I'm KrishnaKanth, a passionate self-taught frontEnd web developer
          from USA. I tend to make use of modern web technologies to build
          websites that look great, feel fantastic, and function correctly. I am
          especially focusing on Reactjs.
          <br />
        </p>
      </AboutInfo>
